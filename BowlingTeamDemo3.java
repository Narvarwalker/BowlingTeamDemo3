// Chapter 8 exercise pages 386 - 388
...
public class BowlingTeamDemo3
{
	public static void main(String[] args)
	{
		...
		// prompt the user to look up a team to see the roster of members
		...
		for(y = 0; y < teams.length; ++y)
		{
			...
			{
				// now that the team name is found, loop through the members to output the roster
				for(x = 0; x < NUM_TEAM_MEMBERS; ++x)
